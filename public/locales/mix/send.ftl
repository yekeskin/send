...
notSupportedDescription = { -send-brand } ma ku Kuachu'un navegador yo. { -send-short-brand } Sachu'in va'a la  versión da ntii  , sachu'un tsi  versión tsa'a su inka kue navegador.
downloadFirefox = Snuú  
...
accountBenefitTitle = Saa iin kuenta ña   a kitsa
# $size is the size of the file, displayed using the fileSize message as format (e.g. "2.5MB")
...
downloadFirefoxPromo = { -send-short-brand } snai ña tsaa  .
# the next line after the colon contains a file name
