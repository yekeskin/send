...
notSupportedDescription = { -send-brand } no funciona con este navegador. { -send-short-brand } funciona mejor con la última versión de  , y funciona con la última versión de la mayoría de los navegadores.
...
accountBenefitTitle = Crear una cuenta   o iniciar sesión
# $size is the size of the file, displayed using the fileSize message as format (e.g. "2.5MB")
