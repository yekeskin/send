...
notSupportedDescription = ഈ ബ്രൌസറിൽ { -send-brand } പ്രവർത്തിക്കില്ല. { -send-short-brand }  - ന്റെ ഏറ്റവും പുതിയ പതിപ്പിൽ വളരെ നന്നായി പ്രവർത്തിക്കുന്നു, കൂടാതെ മിക്ക ബ്രൌസറുകളുടെയും നിലവിലെ പതിപ്പിൽ പ്രവർത്തിക്കുകയും ചെയ്യും.
downloadFirefox =   ഡൗണ്‍ലോഡ് ചെയ്യുക
...
accountBenefitTitle = ഒരു   അക്കൗണ്ട് സൃഷ്ടിക്കുക അല്ലെങ്കിൽ പ്രവേശിക്കുക
# $size is the size of the file, displayed using the fileSize message as format (e.g. "2.5MB")
...
downloadFirefoxPromo = എറ്റവും പുതിയ   { -send-short-brand } മുഖേന നിങ്ങൾക്ക് എത്തിച്ചിരിക്കുന്നു.
# the next line after the colon contains a file name
